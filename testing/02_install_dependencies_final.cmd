@echo off
echo ========================================
echo SSGhub Mail - Install All Dependencies
echo ========================================
...
echo API Gateway: multer, node-cron
echo Admin Portal: react-scripts, @mui/material
echo Webmail Client: react-scripts, i18next, react-i18next
echo.
pause