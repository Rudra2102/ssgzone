@echo off
echo ========================================
echo Task 2.2: Migration Tools API Testing (Port 4000)
echo ========================================

echo Testing migration jobs endpoint...
curl -X GET http://localhost:4000/api/v1/migration/jobs ^
...
if not "%JOB_ID%"=="" (
    ...
    curl -X GET http://localhost:4000/api/v1/migration/status/%JOB_ID% ^
      -H "Authorization: Bearer tenant_admin_token"
) else (
...
echo.
echo Manual steps:
echo 1. Open http://localhost:4001
