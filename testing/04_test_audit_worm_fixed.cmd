@echo off
echo ========================================
echo Task 1.1: WORM Audit Storage Testing (Port 4000)
echo ========================================
...
curl -X POST http://localhost:4000/api/v1/audit/archive ^
...
curl -X GET http://localhost:4000/api/v1/audit/verify-immutable/%LOG_ID% ^
  -H "Authorization: Bearer super_admin_token"
